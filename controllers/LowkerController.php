    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' =>  isset(Yii::$app->user->identity->developer) && (Yii::$app->user->identity->developer || Yii::$app->user->identity->getMenu('lowongan_kerja')->create),
                        'actions' => ['create','data-perusahaan'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => isset(Yii::$app->user->identity->developer) && (Yii::$app->user->identity->developer || Yii::$app->user->identity->getMenu('lowongan_kerja')->read),
                        'actions' => ['index', 'view'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => isset(Yii::$app->user->identity->developer) && (Yii::$app->user->identity->developer || Yii::$app->user->identity->getMenu('lowongan_kerja')->update),
                        'actions' => ['update','data-perusahaan'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => isset(Yii::$app->user->identity->developer) && (Yii::$app->user->identity->developer || Yii::$app->user->identity->getMenu('lowongan_kerja')->delete),
                        'actions' => ['delete'],
                        'roles' => ['@'],
                    ],
                ],
